...
export type ValueTypes = {
    ["Mutation"]: AliasType<{
createPost?: [{	body: string | Variable<any, string>,	title: string | Variable<any, string>},ValueTypes["Post"]],
...
export type ResolverInputTypes = {
    ["Mutation"]: AliasType<{
createPost?: [{	body: string,	title: string},ResolverInputTypes["Post"]],
		__typename?: boolean | `@${string}`
}>;
	["Post"]: AliasType<{
	body?:boolean | `@${string}`,
